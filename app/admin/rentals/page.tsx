...
export default function AdminRentalsPage() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm('Supprimer ce bien locatif ?')) return;
  ...
  if (loading) {
    return <div style={styles.loading}>Chargement des biens...</div>;
  }
  ...
  return (
    <main style={styles.container}>
      ...
      <div style={styles.header}>
        <div>
          <h1 style={styles.title}>Biens locatifs</h1>
          <p style={styles.subtitle}>{rentals.length} bien(s) enregistré(s)</p>
        </div>
      ...
      {rentals.length === 0 ? (
        <div style={styles.empty}>
          ...
          <p>Aucun bien locatif pour le moment</p>
          <Link href="/admin/rentals/new" style={styles.btnAdd}>
          ...
          {rentals.map(rental => (
            <div key={rental.id} style={styles.card}>
              ...
              <div style={styles.cardContent}>
                <h3 style={styles.cardTitle}>{rental.properties?.title || 'Sans titre'}</h3>
