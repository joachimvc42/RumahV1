...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://rentals.rumahya.com/',
  },
  openGraph: {
    title: 'Long-term villa rentals in Lombok — RumahYa Rentals',
    description: 'Verified villas, clear terms, local coordination. Your Lombok rental, done right.',
    url: 'https://rentals.rumahya.com/',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'RumahYa Rentals — Long-term villa rentals in Lombok, Indonesia',
      },
    ],
  },
};
